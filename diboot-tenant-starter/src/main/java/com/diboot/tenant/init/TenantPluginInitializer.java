    ...
    private void insertInitData() {
        ...
        if(resourcePermissionService != null && !resourcePermissionService.exists(IamResource::getResourceCode, "TenantMs")){
            String[] RESOURCE_PERMISSION_DATA = {
               "{\"displayType\":\"CATALOGUE\",\"displayName\":\"租户管理\",\"routePath\":\"tenant\",\"resourceCode\":\"TenantMs\",\"meta\":\"{\\\"icon\\\":\\\"Element:Platform\\\"}\",\"sortId\":\"91\",\"children\":[{\"displayType\":\"MENU\",\"displayName\":\"租户信息管理\",\"routePath\":\"tenant\",\"resourceCode\":\"Tenant\",\"permissionCode\":\"Tenant:read\",\"meta\":\"{\\\"icon\\\":\\\"Element:User\\\",\\\"componentPath\\\":\\\"@/views/tenant/tenant/List.vue\\\"}\",\"sortId\":\"1\",\"children\":[{\"displayType\":\"PERMISSION\",\"displayName\":\"新建\",\"resourceCode\":\"create\",\"permissionCode\":\"Tenant:write\",\"sortId\":\"40\"},{\"displayType\":\"PERMISSION\",\"displayName\":\"更新\",\"resourceCode\":\"update\",\"permissionCode\":\"Tenant:write,Tenant:read\",\"sortId\":\"39\"},{\"displayType\":\"PERMISSION\",\"displayName\":\"删除\",\"resourceCode\":\"delete\",\"permissionCode\":\"Tenant:write\",\"sortId\":\"38\"},{\"displayType\":\"PERMISSION\",\"displayName\":\"详情\",\"resourceCode\":\"detail\",\"permissionCode\":\"Tenant:read\",\"sortId\":\"37\"}]}]}"
            };
            // 插入多层级资源权限初始数据
            try {
