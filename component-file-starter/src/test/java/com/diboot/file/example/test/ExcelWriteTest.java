...
public class ExcelWriteTest extends ApplicationTest {
    ...
    public List<List<String>> buildNormalData(){
        ...
        dataList.add(Arrays.asList("0", "dibo", "研发中心", "10", "正常"));
        dataList.add(Arrays.asList("0", "dibo", "营销中心", "10", "正常"));
        dataList.add(Arrays.asList("0", "dibo", "财务部", "10", "正常"));
        return dataList;
    }
    ...
    public void testWrite() throws Exception{
        boolean success = ExcelHelper.writeDynamicData(getTempFilePath(), "部门列表", buildNormalData());
