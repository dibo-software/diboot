...
(
    id NUMBER(20) generated by default as identity ( start with 10000 nocycle noorder),
    tenant_id          NUMBER(20)           default 0  not null,
    user_type VARCHAR2(100) default 'IamUser' not null,
    user_id NUMBER(20) not null,
...
(
    id NUMBER(20) generated by default as identity ( start with 100000 nocycle noorder) ,
    tenant_id          NUMBER(20)           default 0  not null,
    user_type VARCHAR2(100) default 'IamUser'    not null,
    user_id NUMBER(20)    not null,
    auth_type VARCHAR2(20) default 'PWD'    not null,
