...
create index idx_dbt_msg_tenant on ${SCHEMA}.dbt_message (tenant_id);
create index idx_dbt_msg_template on ${SCHEMA}.dbt_message (template_id);
create index idx_dbt_msg_receiver on ${SCHEMA}.dbt_message (receiver);
