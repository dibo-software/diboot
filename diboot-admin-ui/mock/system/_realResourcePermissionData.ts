  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        routeMeta: {
          icon: 'Element:Menu',
          componentPath: '@/views/system/resourcePermission/list.vue'
        },
        parentDisplayName: '系统管理',
        permissionList: [
          {
      ...
      },
      {
        ...
        routeMeta: {
          ...
          componentPath: '@/views/system/scheduleJob/list.vue'
        },
        parentDisplayName: '系统管理',
        permissionList: [
          {
      ...
      },
      {
        ...
        routeMeta: {
          ...
          componentPath: '@/views/system/messageTemplate/list.vue'
        },
        parentDisplayName: '系统管理',
        permissionList: [
          {
      ...
      },
      {
        ...
        routeMeta: {
          ...
          componentPath: '@/views/system/operationLog/list.vue'
        },
        parentDisplayName: '系统管理',
        permissionList: [
          {
      ...
      },
      {
        ...
        routeMeta: {
          ...
          componentPath: '@/views/system/loginTrace/list.vue'
        },
        parentDisplayName: '系统管理',
