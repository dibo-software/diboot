...
(
    id INT not null ( 10000,1) primary key,
...
CREATE TABLE db_purchase_rel_plan_goods (
                                            ...
                                            purchase_form_plan_id varchar(32) DEFAULT NULL,
                                            goods_id varchar(32) DEFAULT NULL,
                                            create_ts datetime default CURRENT_TIMESTAMP null,
                                            update_ts  datetime null,
                                            is_del BIT DEFAULT 0
...
CREATE TABLE demo_test_join (
                                id varchar(32) not null primary key,
                                demo_test_id varchar(32) DEFAULT NULL,
                                name varchar(100) DEFAULT NULL ,
                                email varchar(100) DEFAULT NULL ,
                                is_deleted BIT NOT NULL DEFAULT 0,
                                create_time datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
...
SET not null_INSERT organization ON;
...
SET not null_INSERT cc_city_info ON;
...
SET not null_INSERT demo_test ON;
...
SET not null_INSERT demo_test_join ON;
