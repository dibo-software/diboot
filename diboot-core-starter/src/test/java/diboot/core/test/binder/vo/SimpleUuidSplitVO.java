...
public class SimpleUuidSplitVO extends User {
    ...
    // ，拆分的id值绑定
    @BindEntityList(entity = TestUploadFile.class, condition="this.`character`=id", splitBy= Cons.SEPARATOR_COMMA)
    ...
    // ，拆分的id值绑定
    @BindFieldList(entity = TestUploadFile.class, field = "fileName", condition="this.`character`=id", splitBy= Cons.SEPARATOR_COMMA)
