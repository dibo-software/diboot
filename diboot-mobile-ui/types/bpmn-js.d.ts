...
declare module 'bpmn-js/lib/draw/BpmnRenderer' {
  ...
  export default class BpmnRenderer extends BaseRenderer {
    ...
    protected _drawPath(parentGfx: SVGElement, element: any, attrs?: Object): SVGElement
...
declare module 'bpmn-js/lib/features/modeling/Modeling' {
  ...
  type Properties = Record<string, string | number | boolean | ModdleElement | null | undefined | unknown[]>
