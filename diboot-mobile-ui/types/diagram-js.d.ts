...
declare module 'diagram-js/lib/features/context-pad/ContextPad' {
    ...
    export default class ContextPad extends ModuleConstructor {
         ...
         */
        getEntries(element: Base):  ContextPadEntryDescriptor[] | Record<string, ContextPadEntry>[] | any
        // 切换菜单显示状态
...
// 网格化生成器
declare module 'diagram-js/lib/features/grid-snapping/visuals' {
...
declare module 'diagram-js/lib/features/popup-menu/PopupMenu' {
    ...
    export default class PopupMenu extends ModuleConstructor {
        ...
        registerProvider(
            id: string,
            priority: number | PopupMenuProvider | ReplaceMenuProvider,
            provider?: PopupMenuProvider | ReplaceMenuProvider
        ): void
...
// touch操作。
declare module 'diagram-js/lib/navigation/touch' {}
// 放大缩小
